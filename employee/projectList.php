<?php
    ...
    $query = $conn->prepare("SELECT * FROM project_members where user_id = :user_id order by id desc");
                                ...
                                <div class="col-12 table-responsive">  
                                    <table id="datatable" class="table align-middle table-nowrap table-hover mb-0" data-page-length='20'>
                                        ...
                                        <tbody >
                                            <?php
                                            $sr_no = 1;
                                            if (isset($project_members_row)) {
                                               if ($project_members_row>0) {
                                                 foreach ($project_members_result as $value) { 
                                                 $project_members_id = $value['id'];  
                                                 $project_id = $value['project_id'];


                                                 $query = $conn->prepare("SELECT * FROM project where id = :project_id order by id desc");
