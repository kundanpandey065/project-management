...
if (isset($_POST['submitFormBtn'])) {
	...
	$query = $conn->prepare("INSERT INTO tasks(project_id,title,description,assigned_by,priority,task_status_id,start_date,due_date,weightage,complete_percentage,created_at,updated_at) values(:project_id,:title,:description,:assigned_by,:priority,:task_status_id,:start_date,:due_date,:weightage,:complete_percentage,:created_at,:updated_at)");
	...
	$query->bindParam(':complete_percentage',$complete_percentage);
